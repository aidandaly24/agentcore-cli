...
We will acknowledge receipt of your vulnerability report within **3 business days** and send a more detailed response
within **7 business days** indicating the next steps in handling your report. After the initial reply to your report, we
...
- We will provide credit to security researchers who responsibly disclose vulnerabilities (unless they prefer to remain
  anonymous)
...
**Note**: This repository is maintained by AWS. Please report issues through the channels described above.
