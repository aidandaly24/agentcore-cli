...
export interface AddGatewayConfig {
  ...
  /** Whether to enable CloudWatch observability (logs + traces) post-deploy */
...
/** Item ID for the observability toggle in the advanced config pane. */
export const OBSERVABILITY_ITEM_ID = 'observability';
