...
/**
 * Shared mode-check helper for `agentcore logs interceptor`. The verb is
 * managed-only — it requires a Lambda the CLI deployed and exposed in
 * deployed-state. External interceptors are routed to a remediation message.
 *
 * The helper:
