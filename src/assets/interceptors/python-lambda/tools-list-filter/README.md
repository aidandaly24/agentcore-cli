# {{ Name }} — tools-list-filter (RESPONSE)
...
Replace the placeholder `is_authorized()` function with your real logic. Common
patterns:

- Read groups/roles from a JWT in `request_headers["authorization"]`.
